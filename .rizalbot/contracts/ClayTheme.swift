...
enum ClayTheme {
    ...
    static let tabletUserMaxWidth: CGFloat = 420
    static let tabletAssistantMaxWidth: CGFloat = 560
    ...
    /// Resizable slate plate — sits on chalkboard, centered, just wider than chat bar (580).
    static let chatBarWidth: CGFloat = 580
    static let slateOverhang: CGFloat = 48
    static var slateWidth: CGFloat { chatBarWidth + slateOverhang }
    /// Chat column inside the slate (bubbles + composer stay within slate).
    static let slateContentInset: CGFloat = 16
